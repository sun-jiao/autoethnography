...
#show: cupst.with(
  title: [Critical Review of Studies on Gender Identity: Conceptual and Methodological Problems and the Need to Consider Cultural Context],
...
This article reviews the literature and identifies several recurring problems. Definitions and studies conflate sex with gender, so that discomfort with bodily traits is read as identification with a gender category. Heritability statistics are treated as evidence of a genetic architecture, which exceeds what such statistics can establish. Molecular biological studies use cross-tissue and cross-taxon analogies without direct empirical support.
...
This article has reviewed definitions and studies of gender identity and identified several recurring problems. First, descriptions of gender identity as necessarily innate are in tension with definitions of gender as socially constructed, unless the relevant sense and the relevant social construct are distinguished more carefully. Second, some neurological studies interpret evidence about bodily representation or general self-processing as evidence about gender identity without establishing the social-cognitive bridge between the two. Third, heritability estimates and genetic associations do not, by themselves, establish a direct or context-free genetic architecture for gender identity.
...
#acknowledgement([
  ...
  // (Note: I explicitly do not identify as "queer" or "genderqueer", because I oppose post-structuralism.)

  I am grateful to friends, both in person and online, for their support during my self-exploration of gender identity. I also appreciate the professional assistance I received from friends and colleagues, especially those in sexology, neurology, analytical philosophy, philosophy of science, and continental philosophy. They either preferred not to be acknowledged by name or had not responded by the time of submission.
])
