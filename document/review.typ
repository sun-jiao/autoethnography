...
Gender identity is crucial to understanding and explaining transgender experiences in society. #textcite(<APA2015Guidelines>, <NHS2022Gender>) define gender identity as something a person is born with -- an "inherent" or "innate" sense. This "born this way" framing has real political appeal @Glazier_2021. However, it contradicts the widely accepted view that gender is a social construct @King_2010@S_nchez_2025.

This article reviews the literature and identifies several recurring limitations. Definitions and studies conflate sex with gender, so that discomfort with bodily traits is read as identification with a gender category. Heritability statistics are treated as evidence of a conclusion that exceeds what they can establish. Molecular biological studies use cross-tissue and cross-taxon analogies without direct empirical support. It should be noted that not all studies claim that gender identity is innate. Nonetheless, even those that do not make this claim or explicitly reject it are often trapped in the same conceptual and methodological limitations and presuppose a biological essentialist framework.

Against this background, I examine two studies that place gender identity within a predictive-processing framework @Tacikowski2020Fluidity@Clausen2021Action. Inspired by them, I propose a model in which gender is a social-norm system linking ontologically independent attributes, and gender identity is the self-model the brain settles on to minimise prediction errors.
...
Therefore, I do not use the term "biological sex" in this article. Instead, I use "phenotypic sex" to refer to the conventional notion of "biological sex" as a set of sexually dimorphic traits, and "birth-assigned sex" or "sex assigned at birth" to refer to the label assigned on the basis of observed phenotypic sex at birth. I distinguish the two concepts because birth-assigned sex is a social label and is not equivalent to a specific phenotype. It depends on the practice of birth sex assignment, which is a social institution. However, some neurological phenomena, such as body-representation incongruence, are not socially constructed. They can exist independently of birth sex assignment.

= Ambiguity and internal contradiction in definitions

#textcite(<APA2015Guidelines>) defines gender identity as "A person's deeply-felt, inherent sense of being a boy, a man, or a male; a girl, a woman, or a female; or an alternative gender (e.g., genderqueer, gender nonconforming, gender neutral) that may or may not correspond to a person's sex assigned at birth or to a person's primary or secondary sex characteristics." However, what is meant by "deeply felt", "inherent sense", and "being a gender"? These notions are poorly defined. The definition may also be overgeneralised. If someone -- for example, me -- did not experience their gender identity as deep or inherent, but instead regarded it as a contingent product of childhood experience, would the APA definition render that identity invalid?
...
Some neurological or genetic studies adopt the above definitions or have similar issues. Among the articles reviewed here, #textcite(<Polderman2018Biological>) adopts the APA definition, #textcite(<Ramirez2021Implications>) uses "innermost sense", and #textcite(<Majid_2020>) uses the term "fundamental, inner sense".
...
#textcite(<Majid_2020>) is a representative empirical study within what #textcite(<Zabalegui2024After>) terms the hypothesis of self-referential thinking and body perception (HSRTBP), and is regarded as the least essentialist and potentially the most depathologising of the three frameworks. My concern differs from her broader critique of this framework: I focus specifically on whether the neural constructs measured in this study justify claims about gender identity as such. #textcite(<Case2017Altered>), which is not part of #posscite(<Zabalegui2024After>) discussion and investigates different neural mechanisms, is included as an independent comparison. Despite these neuroscientific differences, it raises a philosophically analogous question about the inferential transition from bodily representation to gender identity. The purpose of these cases is therefore not to provide an exhaustive survey of neuroimaging research, but to examine a recurring problem of construct interpretation across distinct neuroscientific approaches.

#textcite(<Case2017Altered>) stimulated the breasts and hands of transgender men (FtM) and cisgender women (controls), measured brain activity using magnetoencephalography, and examined white-matter connectivity with diffusion tensor imaging. No significant group difference appeared during hand stimulation. During breast stimulation, however, the responses diverged sharply. In the FtM group, activation was reduced in the supramarginal gyrus and secondary somatosensory cortex, but increased in the medial temporal lobe, including the amygdala/peri-amygdaloid cortex.
...
#textcite(<Case2017Altered>) argue that gender dysphoria primarily arises from conflict between the physical body and neural representation, and that this conflict weakens sensory integration. They propose that a multimodal body representation may be innate, while also being shaped by culture and personal experience, making it difficult to distinguish innate and acquired components.

Their treatment of the nature-nurture issue is careful. However, the study provides evidence relevant to body-related dysphoria or body representation. This evidence does not directly establish a mechanism for gender identity as a self-categorical construct. Whether innate, acquired, or mixed, this phenomenon is not identical to "gender identity". What they studied was body-representation incongruence. #textcite(<Case2017Altered>) did not demonstrate how this raw feeling yields a "sense of being a (trans) man." An additional account (likely a cultural one) is required to derive it. The interpretation exceeds what the data directly support.

For example, the authors explicitly compare this pattern with xenomelia. People with xenomelia similarly report bodily aversion and reduced ownership, and similarly show reduced thickness in the secondary somatosensory cortex @Hilti2013. This indicates that a mismatch between neural body representation and actual body structure is an independent neural phenomenon that can exist without social constructs. Social role incongruence can also arise through other pathways, as many transgender individuals do not report body-representation incongruence @T_Sjoen2019Endocrinology@brecht2024analyzing.
...
#textcite(<Majid_2020>) conducted a study in which cisgender and transgender participants viewed computer-altered images of their own bodies in an fMRI scanner, including masculinised and feminised versions. Neural activation patterns were highly similar when cis participants viewed images congruent with their birth-assigned sex and trans participants viewed images incongruent with their birth-assigned sex but congruent with their gender identity. Shared activations included the dorsomedial prefrontal cortex (dmPFC), ventromedial prefrontal cortex (vmPFC), and posterior cingulate cortex (PCC). The authors interpret this as evidence that self-perception networks track gender identity rather than phenotypic sex.

The mPFC and PCC serve as general self-processing regions @Northoff_2006@Qin_2011@Qin_2013. The representations are linked to the importance of an attribute to one's self-identity @Levorsen_2023. #textcite(<Sng_2026>) shows that national and ethnic identity modulate vmPFC activity. #textcite(<Han_2008>, <Wu_2010>) establish that religious beliefs also influence self-referential processing. Different forms of identity, including clearly acquired ones, can recruit mPFC-based self-referential processing. Therefore, this does not demonstrate the existence of "self-processing networks specific to gender identity," as the authors claim.
...
Genetic studies of gender identity are another area of concern. #textcite(<Polderman2018Biological>) reviewed the heritability evidence on gender identity. Drawing on twin studies, the authors estimate heritability to be 30–60%, conclude that "gender identity is a multifactorial complex trait with a heritable polygenic component," and propose further investigation of "the genetic architecture of gender identity through genome-wide association studies".
...
Heritability is a widely misunderstood biological concept. In quantitative genetics, heritability is a variance-partition statistic for a specific population under a specific range of environments. It is not a claim about causal mechanism or biological essence, and it does not reveal the underlying mechanism of a phenotype @lewontin1974annotation@Turkheimer_2000@Vineis2011Genome.
Political stance, educational achievement, and occupation all yield mathematically valid heritability estimates @Hatemi_2007@Krapohl_2014@Marks_2017. Heritability cannot determine whether genes have direct effects on traits.
...
#textcite(<searle1995construction>) distinguishes brute facts from institutional facts. Brute facts exist independently of human social culture, such as a person's height. Institutional facts exist only under specific social institutions, such as a person's political stance. The former is a biological trait, while the latter is a socially constructed attribute.

For height, genes and environment would still interact and jointly determine it even without human social culture, as in non-human animals. Social structure serves only as one (or several) specific environmental components. By contrast, the heritability of political stance is meaningful only under specific institutions, such as elections and party systems. Interpreting that number as evidence that "voting preference is encoded in genes" is untenable. Without that institutional context -- for example, under a monarchy without elections -- the measure is not even definable.
...
SSBRI could constitute a brute fact because it is a neural phenomenon that can exist independently of social constructs. Non-human primates also have body representations in their brains @fang2019statistical@maravita2003multisensory.
It is biologically reasonable to suppose that individual differences may exist in non-human primates between sexually dimorphic physical morphology and the neural representation of their own bodies, although there is currently no evidence for this. Even if they had an SSBRI, however, it could not be integrated with social norms to form a gender identity, because they do not have social gender constructs. As argued in Section 2, gender identity depends on a social gender construct and is therefore an institutional fact.

The genetic architecture of an institutional fact is necessarily population-, measurement-, and institution-relative. The statement "it has a genetic architecture" is technically true. However, the statement "a social construct has a statistical genetic structure" is trivial and obscures the intermediate mechanism. "What heritable brute facts can interact with social norms to produce gender identity?" should be a scientific question with more biological, psychological, and sociological value than "Which genes are related to gender identity?"

= Methodological limitations in molecular biological studies

#textcite(<Ashley2023Genetic>) conducted a systematic review and meta-analysis of genetic association studies. I reviewed the original studies included in it and identified several methodological limitations.
...
The case of #textcite(<Theisen2019>) is similar. Of the 21 variants it reports, every one except DIAPH2 appears in only a single transgender individual. The actual evidence base is only that a single person carries a rare variant in each of 29 genes, and that the relevant gene is loosely related to a pathway in mice.

The causal relationships proposed by #textcite(<Foreman2019Genetic>) are inferred from other physiological functions of the associated genes, such as bone mineral density, prostate cancer, or ADHD, and then extrapolated to the gender-dysphoria context. Even if these genes are statistically associated with gender dysphoria, that does not prove a causal relationship. The authors treat an association as functional evidence and then transfer that functional evidence from other conditions to gender dysphoria, without direct functional validation of the gene variant in the phenotype at hand.

The association between gender dysphoria and ADHD (and the broader neurodivergent population) is well documented @strang2014increased@Bonazzi2025Gender. However, the reasons for the co-occurrence remain uncertain @bretherton2021health. #posscite(<goetz2024transgender>) meta-analysis finds that current studies have largely documented prevalence, whereas potential mechanisms have received little empirical investigation. We have no reason to assume that the co-occurrence is due to biological, psychological, or social factors.
...
#textcite(<Foreman2019Genetic>) also cites #textcite(<gennari2005estrogen>), which found that shorter TA repeats in _ESR1_ (_ERα_) are associated with lower bone mineral density in women; the authors infer that shorter TA repeats lead to weaker estrogen signalling. Nonetheless, according to #textcite(<kos2001minireview>, <Wilson2008Dynamic>), different organs may not use the same _ESR1_ promoter. There are several _ESR1_ promoters (A, B, C, D, E1/E2, F, and T1/T2). Mammary cells mainly use A and C, osteoblasts use F, and different regions of the brain use A or B. Therefore, the same polymorphism may have different functional effects in different tissues. For instance, #textcite(<chan2007estrogen>) demonstrate that (TA)#sub[16] has significantly higher activity than (TA)#sub[22] and (TA)#sub[23]. Therefore, the cross-region analogy from bone to brain is problematic.

The studies of #textcite(<fernandez2020analysis>, <Ramirez2021Implications>, <henningsson2005sex>) are partly based on inferences from the model that oestrogen masculinises the rodent brain. This phenomenon is well established @wu2009estrogen.
...
#textcite(<Theisen2019>, <fernandez2018molecular>, <henningsson2005sex>) also make extensive use of these rodent brain-region pathways. Another problem with this analogy is that, in the original rodent studies, the behaviours of interest are lordosis (the female's sexual receptivity posture) and mounting and thrusting (the male's copulatory postures). These differences in mating behaviour appear only after sexual maturation @McCarthy2008Estradiol@McCarthy2017.
Even if we assume that these genes act in the same way in humans as in rodents (which has not yet been demonstrated), their effects should be to produce specific sexual behaviours in humans after sexual maturation, not gender identity. There is no logical basis for interpreting the receptor genes that determine rodents' mating postures as the cause of human gender identity.

Even if we make another concession -- that this behavioural difference _is_ gender identity, or that it promotes the emergence of gender identity through some sociocultural factor -- there is still a contradiction. Many transgender people were clearly aware of their gender identity in childhood. #posscite(<Fahrenkrug2025>) study of a gender-identity clinic in Germany found that 51% of the whole sample showed the "early-onset" type (meeting the criteria before the age of 12), while 49% showed the "late-onset" type (meeting the criteria at age 12 or older). Even #textcite(<fernandez2018molecular>) explicitly focus on "early-onset" transgender people. Although the sexual differentiation of the rodent brain occurs in the perinatal period, it manifests at the behavioural level only after sexual maturation @McCarthy2008Estradiol@McCarthy2017.
...
The specific causal relationship demonstrated in rodents cannot be transferred across taxa, phenotypes, and time without additional evidence. At present, the shared association of both phenomena with sex-related differentiation is insufficient to establish that correspondence.
...
Moreover, these studies' equation of brain-developmental pathways with gender identity rests largely on neurological studies that see transgender experience as arising from a "cross-sex" (opposite-phenotypic-sex-typical) brain structure @fernandez2018molecular. However, as noted earlier, #textcite(<Zabalegui2024After>, <Baxendale2025Brain>) have pointed out that these studies have serious conceptual and statistical problems.

= Predictive processing framework and empirical studies

A common question follows: if "born this way" is untenable, why does gender identity often feel innate? I do not deny this. Indeed, my own gender identity subjectively feels very "innate".

However, I suggest that "pre-reflective" is more accurate than "innate". Pre-reflective psychological processes are fast, habitual, and embodied, so they are not ordinarily experienced as objects of conscious reasoning. By contrast, "innate" concerns developmental origin. A process can be acquired and still occur automatically, and may be experienced as if it were given. Many studies show that culture shapes automatic psychological processing @Gutchess2006@Kitayama_2010@Mason_2010@Qu_2021.

Predictive processing (PP) is a strong mechanistic candidate for explaining why pre-reflective processes feel innate. It explains the transition from experiential learning to automatic prediction, and why one does not experience oneself as consciously inferring @Clark2013Whatever. I have identified two studies that place gender identity within a predictive-processing framework:
...
Experiment 3 tested whether the effect extended to self-attributed gender stereotypes. Participants completed the Bem Sex-Role Inventory @bem1974measurement, rating traits such as competitiveness, sympathy, or gentleness. Under a stronger illusion, they more strongly endorsed traits stereotypically associated with the opposite gender.
...
Experiment 3 is especially informative. If we were in a culture without social gender construction, a full-body illusion could generate prediction error at the bodily level only. It could update body perception, but not personality-trait expectations. A perceived shift towards an opposite-phenotypic-sex body form is ontologically distinct from perceived increases in traits such as competitiveness or sympathy. A mediating structure is therefore required. A plausible candidate is the social gender norm, which links body form with trait expectations. If male body form is normatively linked to competitiveness, then perceiving one's body as more male creates prediction error against a previous belief such as "I am not competitive."

For the brain to move from "my body representation has changed" to "my personality should change," it must recruit a knowledge structure encoding links between $"body feature" X -> "personality trait" Y$. Those links arise from culturally learned gender stereotypes rather than direct sensorimotor physiology. In this sense, the study operationalises social gender norms as a testable latent mechanism connecting bodily-representation updates with self-concept updates.

This aligns with the "Thinking Through Other Minds" (TTOM) model proposed by #textcite(<Veissi_re_2019>). Its core claim is that humans acquire shared habits, norms, and expectations through immersion in patterned cultural practice, and that these expectations selectively shape attention and action. A substantial portion of our cognitive resources is "outsourced" through inference about others' priors. The relationship between body feature X and trait Y functions as precisely such a cultural prior.

Similarly, #textcite(<Clausen2021Action>) designed a system that altered the frequency of participants' footsteps in real time. Participants wore instrumented sandals. Microphones attached to the sandals captured impact sounds, which were amplified and equalised, then replayed through isolating headphones that blocked unprocessed sound. Two extreme conditions were used: high-frequency amplification, making footsteps sound lighter and more stereotypically feminine, and low-frequency amplification, making them sound heavier and more stereotypically masculine.
...
Within this research domain, gender can be treated as a social-norm system that links ontologically independent attributes. In a given setting, gender categories may be associated with particular bodily features, forms of dress, colours, activities, occupations, and personality traits. Through TTOM-like cultural learning in childhood, we internalise these priors and use them to infer self-identity and organise behaviour. Trait combinations that violate these priors may be experienced as prediction errors relative to others' expected models, prompting self-model updating towards one side of the norm structure. Since anatomy is only one feature among them, the resulting gender identity need not align with one's birth-assigned sex.

SSBRI is not social gender itself, but it can be an early and strong physiological negative signal. This signal, regardless of whether it is innate, may provide a salient and repeatedly weighted mismatch that biases the updating of higher-level self-models. It also shifts one's expectations and perceptions of other personal attributes, since they are linked to body morphology in gender. People without SSBRI may still converge towards an incongruent identity through other mismatches between their traits and gender-norm expectations, or through other social factors or personal experiences.

This model is empirically testable in principle, and the two studies above provide initial support. However, those experiments induced short-term shifts under controlled laboratory conditions. This differs from the long-term development of a stable, durable identity over years. At present, these papers do not show that temporarily induced shifts are capable of shaping enduring identity. That remains an extrapolation, although a logically reasonable one.
...
A useful next step is cross-cultural testing. Researchers could first identify, through independent norming studies, a physically identical cue that is strongly associated with different genders in two different cultures. Participants could then undergo the same body-ownership or embodied-perception manipulation while exposed to that cue. The present model predicts that changes in gendered self-perception should follow the locally learned meaning of the cue. A cue coded as feminine in one culture but coded as masculine in another should therefore produce correspondingly different patterns of self-model updating.

Another consideration is the careful selection of cues to avoid biological-essentialist explanations. For #textcite(<Tacikowski2020Fluidity>), an essentialist may argue that cis women who experienced male body illusions simulated the physiological capacities of such a body, such as greater strength or testosterone-linked behavioural tendencies, and therefore reported increased competitiveness. I do not endorse that view, but it is internally coherent and makes predictions similar to those of the present model, so existing results cannot fully discriminate between them. To avoid debates over whether competitiveness is a biological attribute of males, future tasks can focus on markers with clear historical volatility or strong cross-cultural divergence. Suitable examples include high heels, skirts, stockings, or long hair. For such markers, biological-essentialist accounts are less plausible.

= Consider cultural factors in genetic studies

Since gender identity relies on the social construct of gender, genetic studies of it must consider cultural factors. Social science genetics, or sociogenomics, is a growing field that studies the interaction between genes and the social environment. It explores how DNA variation relates to or influences socially shaped behaviours or other outcomes, including educational attainment, occupation, income, political attitudes, health, and social mobility @harden2020using@mills2020sociology.

This means that the outcome measure in genetic studies of gender identity must be specified in a way that recognises its inseparability from its social setting. Researchers should describe the jurisdiction, cohort, language, and recruitment pathway that define the studied population, report the measures used to operationalise gender identity and gender dysphoria, and avoid treating categories drawn from different cultural settings as interchangeable. Where feasible, designs should measure relevant aspects of the social environment, including local gender norms, family and peer contexts, discrimination, and access to gender-affirming care.
...
The evidence reviewed here is not sufficient to establish this model as a theory of the development of durable gender identity. The available experiments concern short-term, laboratory-induced changes and should not be treated as direct demonstrations of lifelong identity formation. The appropriate next step is to test competing models using transparent measures, cross-cultural designs, and preregistered predictions. Such research can clarify the contributions of social learning, bodily experience, and developmental context without conflating them.

#acknowledgement()[
  I self-identify as non-binary (gender-fluid). This article is motivated by self-exploration of my own gender experience, which cannot be explained by the "born this way" narrative. I traced the formation of my gender identity under the predictive-processing framework and wrote an autoethnography, which may be published elsewhere in the future. I am grateful to friends for their support during my self-exploration of gender identity.
]
