...
// In this appendix, I will trace the history of my own gender identity under the framework we established earlier. I am a phenotypic male and assigned male at birth. My self-identification lacks a stable categorisation within the current gender system, arguably aligning with "genderfluid" or "agender", but I view these labels as pragmatic rather than ontological. I am comfortable with all pronouns. This autobiography is mainly for making the theory more vivid and easy to understand, rather than proving universal rules on its own. Additionally, it serves as a counterexample to the "innate gender identity" theory of transgender essentialism @APA2015Guidelines, NHS2022Gender, the "standpoint epistemology" of the feminist philosophy @Haraway1988Situated, and the criticism of reason as a hegemony by post-structuralism and feminist philosophy of science @Irigaray1985Subject, Harding1986Science. From a Habermasian aspect of communicative rationality, I completely permit queer theorists to use this autobiographical case study as an example for the "gender performativity" theory or other constructivism theories, though I completely reject them. %The female components of my gender identity will be discussed first, followed by the male components. %This section is complementary to the core biological arguments. Moreover, we will discuss some extremely controversial topics, using myself as an example of transgender people can avoid offending others.
//\texttt{AttributeError: object 'user' has no attribute 'gender_identity'}.

// I have a strong desire to adopt a more feminine name: 娇 (_Jiāo_, will be addressed as "the feminine _Jiāo_"). This character means "cute" or "adorable" and features the "woman" radical. It is a homophone and graphically like my legal name (骄, _Jiāo_, means "pride", relatively neutral). I suspect my preference for the feminine _Jiāo_ was shaped by repeated misuse. It was frequently miswritten or mistyped as the feminine _Jiāo_ in my life due to the input method issue. #footnote[When typing in Chinese, we use a software called "input method." It gives all possible Chinese characters based on the pinyin, and the user chooses the correct character from them. It is a common thing to choose a wrong character.] I felt ashamed and uncomfortable about it when I was in elementary and middle school, but I gradually came to like it. (\cref{fig:name})
...
Detailed reasoning and justification, as well as the reason I refused other theories, 
can be found in #plaincite(<Sun2025GenderAbolition>). 
Having established this premise, what I should do next was clear: 
to introspect on everything related to gender in my grown-up and how they might have shaped my "gender identity."
...
I believe that my body representation was consistent with my body in my childhood as I did not experience body dysphoria at that time. However, I have neurodermatitis (also known as lichen simplex chronicus) in my scrotum. There are multiple studies supporting that chronic itching and pain can affect one's body image @Simsek2020Body@Vamos1993Body. This could be a reason why I dislike my reproductive organs. However, it should be noted that I developed neurodermatitis much later than the childhood events mentioned above, and neurodermatitis itself is a psychosomatic disease heavily influenced by psychological and mental states @Lotti2008Prurigo@Tey2013Psychosomatic. Therefore, it might be a physiological result of pre-existing gender dysphoria, or it might serve as a key point in a feedback loop that enhanced my gender dysphoria.

Therefore, it is concluded that: my current so-called "gender identity" is a synthesis of this aesthetic longing for the female body, envy of the reproductive function, and an internalised reaction to childhood experiences and trauma. Our life experiences and psychological responses to external stimuli are interwoven like a dense net, or rather, like a chain reaction, where one event triggers multiple preceding events, which continue to trigger subsequent events. Then we pick out a few phenotypically similar phenomena, give them a name: "gender identity." This is pure tautology and has no other meaning. (@fig:bundle)
...
On the other hand, the male components are relatively simple: body representation congruence and the external imposed male socialisation. In particular, there is a representative anecdote worth mentioning. I have a deep aversion to radical "feminists" who attack and stigmatise all men. My stance can be traced to Victor Hugo's _Letter to Captain Butler on the Expedition to China_ (_L'Expédition de Chine. Au capitaine Butler_), which we learned in middle school language art courses @Kecheng2007Yuwen:
