...
#textcite(<Sun2025GenderAbolition>) can be considered in the "context of justification,"
...
// Moreover, if we examine this work from a post-structuralist perspective, it holds that reason and science are essentially just one specific discourse among many. Under their epistemology, "a transgender biology PhD student exploring their gender identity" is not essentially different from "a transgender Buddhist exploring their gender identity." The conflict between biological knowledge and an "innate, profound gender identity" (an unverifiable ontological assumption) is no different from the conflict between Buddhism and the idea of a "female soul born in a male body" (Buddhism does not consider the soul to have a "gender;" a person could even be an animal in their next life, making a discussion of the soul's gender meaningless). Both are stories of an individual's experience in coping with two conflicting discourses, both of which relate to important aspects of their existence.

On the other hand, autoethnography is a unique genre in which the author's own
philosophical and scientific stances are part of the data.
The soul of autoethnography lies in honestly presenting how the
"self" (auto-) experiences and understands "culture" (ethno-).
My "self" is the one who has been scientifically trained,
committed to rationality, and tries to use logic and order to understand a chaotic and painful world.
Not to do so would be dishonest.
My insistence on "evidence," "credibility of introspection,"
and my desire to construct a "hypothesis" with "explanatory power" are not merely tools for writing and research;
