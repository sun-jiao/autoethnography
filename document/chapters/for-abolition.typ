...
Based on my previous analysis, gender construct can be reformed as a corrupted training data that contains two flawed classes: Class 0 (female) is consisted of feminine faces, vaginas, clitorises, developed breasts, pink, purple, housework, cooking, dolls, stuffed toys, dresses, Mary Jane shoes, jewelleries, make-up, quietness, introversion, baby-caring ... Class 1 (male) is made up of masculine faces, penises, testicles, undeveloped breasts, Adam's apples, beards, blue, computers, documents, architecture, toy cars, pants, suits, ties, naughtiness, extroversion ... An individual's gender identity is an emergent property of their nervous system after being trained on it. 

// "Gender identity" is our brains desperately trying to find a pattern in a chaotic, nonsensical, and wrongly labelled set of social data. It latches onto these arbitrary connections and creates a rigid internal model that doesn't actually reflect a fundamental reality.

Therefore, the most fundamental "-centrism" in our society is not androcentrism, heterocentrism, or cisgender-centrism, but gender-centrism (hereby proposed, alternative names can be "gender ideology" or "gender-centric ideology") -- an ideology that establishes "gender" as the core category for understanding the world and ourselves. It categorises ontologically unrelated things together, assigning gender labels to everything, establishing "gender" as the centre of how people perceive the world. It prevents humans from perceiving the real mathematical structure of the objective biological, psychological, and sociological diversity of human beings. By doing so, it restricts our freedom of choice among these ontologically unrelated things, making unnamed combinations (e.g. an extroversive person with a penis, who likes wearing dresses, playing with dolls and toy cars, programming, and raising babies) invisible and inaccessible. 

// The gender-centrism is so ancient, so deep, that even the most so-called "liberatory" theories or social movements have not escaped it or do not dare to escape it. They merely try to change cells within the prison. They resist the "oppression of gender," but they are afraid, unwilling, unable, or refuse to resist the existence of "gender" itself.

// From the perspective of predictive coding model, any concept that contains non-essential
// stereotypes can be "trans"-ed, like race, nationality, age, species, height ...
// Only transgenderness being regarded as a respectful human rights is not progressive, but
// a new kind of oppression and the newest version of gender-centrism.
// It re-enforces gender as the centre of understanding human experiences.
// Transgenderness is nothing more special than other kinds of "trans-ness," considering it
...
Since the real problem lies in an omni-encompassing ideology that attempts to assign "gender" to everything, the most fundamental solution is to abolish the whole gender construct. I hereby propose a solution aiming at abolishing gender by strictly limiting or dismantling "sex" and "gender" to atomic entity, detaching them from individuals.
...
The biological sex should be strictly confined to the gametes @Lehtonen2014Gamete@Goymann2023Biological@Hurst1996There@Griffiths2025Biology. 
//It is related to, and only to, gametes. Individuals do not have such a sex. 
Sexual dimorphism is a dynamic spectrum that constantly changes throughout evolutionary history. The so-called "phenotypic sex" should be dismantled into a series of discrete, decentralised, atomic phenotypic traits such as chromosomes, hormones, as well as all morphology and anatomical traits. They are distributed on the sexual dimorphism spectrum, along with other sexually dimorphic traits not traditionally classified as "sex" (phenotypic sex), like height, weight, body hair, and body fat percentage @Wells2007Sexual. The phenotypic sex, as a distinct, independent entities, should be dropped. Individuals do not have an innate gender; they merely "possess" gametes and sexual dimorphic traits, "live in" a society and "internalise" the gender construct.
...
#textcite(<Parvin1982Ovulation>) reported a person who was completely "phenotypic male" and had fathered a daughter, but one of their two "testicles" was actually a pure ovary (not an ovotestis), and dissection showed it had previously ovulated. Therefore, most people, even those who have had children, cannot know for sure whether they are capable of producing two types of gametes. By biologically confining sex strictly to an unobservable trait, it cannot be "assigned" or "inferred." This makes it lose any possibility of being used for social classification, discipline, and oppression. It becomes a technical term of reproductive biology, completely "exiled" from politics and our daily life.

It should be noted that my proposal is completely different from conservatives, who claim to adopt gametic definition, but still rely on the genital in practice, which is self-contradictory. This even includes some conservative scientists, like #textcite(<Sokal2024Sex>), who claim that sex is an "objective biological reality," "determined at conception and observed at birth." I agree that sex _sensu stricto_ is an objective biological reality, and is strictly binary in Vertebrata. While according to #textcite(<Jones2006Gamete>), "Conception occurs when a sperm and an ovum fuse to become a zygote." "The process of fertilisation, or conception, involves fusion of the nucleus of a male gamete (sperm) and a female gamete (ovum) to form a new individual." At "conception" (fertilisation), one was just a zygote, a single cell. It has neither sex _sensu stricto_ because it cannot produce its own gametes, nor does it have phenotypic sex since it lacks a developed body. Even if its genome guide it to develop into a typical phenotypic male or female under normal conditions, it will not necessarily be so. For instance, if a 46, XY zygote loses its Y chromosome during the first mitotic division after fertilisation, it will develop into a 45, X0/46, XY chimaera (mixed gonadal dysgenesis) or a 45, X0 individual with Turner syndrome @Gravholt2017Clinical@Jacobs1997Turner@Lopes2014Mosaicism.

I recognise that the binary sex is still a very useful model in evolutionary biology, ethology, and reproductive ecology. It is obviously technically and ethically impossible to capture and dissect all individual animals to examine the gametes they produce. In these cases, researchers should state in their _Materials and Methods_ section what proxy they used to estimate the gamete production capacity and the reliability, such as the situation in birds demonstrated by #textcite(<Hall2025Prevalence>). Sex _sensu stricto_ itself is a technical term for a microscopic reproductive biological trait, not an externally observable morphological character.
...
Our goal is to make each word correspond to a single, logically atomic entity. If vagina is just vagina (an organ), pink is just pink (a colour), dress is just dress (a type of clothing), and introversion is just introversion (a personality trait), having no relation to each other, then all the different, mathematically possible combinations are equally accessible and usable.
