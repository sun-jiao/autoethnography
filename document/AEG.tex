...
\section{Abolishing Gender}\label{sec:abolishing-gender}
\input{chapters/abolishing-gender}
...
Code for generating this document and visualising the author's experience (\cref{fig:bundle}): \url{https://github.com/sun-jiao/autoethnography}
