...
\input{.archive/introduction}

\section{My Experience}\label{sec:my-experience}
\input{.archive/experience}

\section{Biological Critique of Gender Identity}\label{sec:biological-critique}

Subsequently, I read some biological and neurological studies and analysed their logical and scientific consistency.

%\input{chapters/introduction}

\input{chapters/dismantling-sex}

\input{chapters/biological-critique}

%\section{Myself: A Case Study}\label{sec:myself-a-case-study}

\section{My Gender Identity: A Case Study}\label{subsec:my-gender-identity}
...
\subsection{Dialogue with Gender pluralism}
\input{chapters/dialogue-with-pluralism}

\subsection{Dialogue with Queer Theory}
\input{chapters/dialogue-with-queer}

\subsection{Dialogue with Post-Structuralism}
...
\section*{Postscript: meta-ethnography behind the autoethnography}
